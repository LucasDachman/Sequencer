...
public:
	...
	MidiDeviceListBox(const String& name,
		MidiViewComponent& contentComponent,
...
//==============================================================================
void MidiViewComponent::addLabelAndSetStyle(Label& label)
{
...
//==============================================================================
void MidiViewComponent::paint(Graphics&)
{
}

//==============================================================================
void MidiViewComponent::resized()
{
	const int margin = 10;
...
//==============================================================================
void MidiViewComponent::buttonClicked(Button* buttonThatWasClicked)
{
...
//==============================================================================
bool MidiViewComponent::hasDeviceListChanged(const StringArray& deviceNames, bool isInputDevice)
{
...
MidiDeviceListEntry::Ptr MidiViewComponent::findDeviceWithName(const String& name, bool isInputDevice) const
{
...
void MidiViewComponent::closeUnpluggedDevices(StringArray& currentlyPluggedInDevices, bool isInputDevice)
{
	ReferenceCountedArray<MidiDeviceListEntry>& midiDevices = isInputDevice ? midiInputs
		: midiOutputs;
...
void MidiViewComponent::updateDeviceList(bool isInputDeviceList)
{
...
//==============================================================================
void MidiViewComponent::timerCallback()
{
...
//==============================================================================
void MidiViewComponent::handleNoteOn(MidiKeyboardState*, int midiChannel, int midiNoteNumber, float velocity)
{
...
//==============================================================================
void MidiViewComponent::handleNoteOff(MidiKeyboardState*, int midiChannel, int midiNoteNumber, float velocity)
{
...
//==============================================================================
void MidiViewComponent::sendToOutputs(const MidiMessage& msg)
{
...
//==============================================================================
void MidiViewComponent::handleIncomingMidiMessage(MidiInput* /*source*/, const MidiMessage &message)
{
...
//==============================================================================
void MidiViewComponent::handleMessage(const Message& msg)
{
	...
	midiString << String(" Midi #: ");
	midiString << String(mm.getNoteNumber());
	midiString << String(" Channel: ");
	midiString << String(mm.getChannel());
	midiString << String(" isControllerMsg: ") << String(mm.isController());
	midiString << "\n";
...
//==============================================================================
void MidiViewComponent::openDevice(bool isInput, int index)
{
	if (isInput)
	{
		...
		{
			DBG("MidiViewComponent::openDevice: open input device for index = " << index << " failed!");
			return;
		}
	...
	else
	{
		...
		if (midiOutputs[index]->outDevice == nullptr)
			DBG("MidiViewComponent::openDevice: open output device for index = " << index << " failed!");
	}
}

//==============================================================================
void MidiViewComponent::closeDevice(bool isInput, int index)
{
	if (isInput)
	{
		jassert(midiInputs[index]->inDevice != nullptr);
...
//==============================================================================
int MidiViewComponent::getNumMidiInputs() const noexcept
{
	return midiInputs.size();
}

//==============================================================================
int MidiViewComponent::getNumMidiOutputs() const noexcept
{
...
MidiViewComponent::getMidiDevice(int index, bool isInput) const noexcept
{
